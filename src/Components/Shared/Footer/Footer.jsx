...
const Footer = () => {
    return (
        ...
        <div>
          ...
          <p>Chief's Pantry.LTD<br/>Providing reliable tech since 1992</p>
        </div> 
        <div>
        ...
        <div className=' inline-flex my-auto gap-2'>
            <FaFacebook className='w-6 h-6 me-3 text-blue-400'></FaFacebook>
            <FaGoogle className='w-6 h-6 me-3 text-red-700'></FaGoogle>
