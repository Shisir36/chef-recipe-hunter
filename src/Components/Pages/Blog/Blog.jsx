...
const Blog = () => {
    ...
    return (
        <div>
        <div  className='px-10'>
        <h2 className='md:text-7xl text-6xl title mt-2 text-green-500 text-center mb-4'>Blogs</h2><hr className=' border md:w-6/12 w-11/12 text-center mx-auto' />
        <div ref={ref} className=' md:flex gap-8'>
       <div className=" h-3/5">
        <div className="container mx-auto my-20 w-full">
          <div
            tabIndex={0}
            className="collapse collapse-arrow border border-base-300  rounded-box bg-green-600 mb-7"
          >
          ...
          <div
            tabIndex={0}
            className="collapse collapse-arrow border border-base-300 bg-green-600 rounded-box mb-7"
          >
          ...
          <div
            tabIndex={0}
            className="collapse collapse-arrow border border-base-300 bg-green-600 rounded-box "
          >
            <div className="collapse-title md:text-2xl text-xl text-slate-50 font-medium">
    ...
    <Pdf targetRef={ref} filename="code-example.pdf">
        {({ toPdf }) => <button className="btn btn-outline btn-success hover:bg-slate-600 hover:text-white  font-semibold text-red-600  text-xl" onClick={toPdf}>Generate Pdf</button>}
      </Pdf>
      </div>
    </div>
    );
